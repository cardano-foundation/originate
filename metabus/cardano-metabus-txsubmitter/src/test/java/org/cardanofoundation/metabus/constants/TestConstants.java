...
public class TestConstants {
    ...
    /**
     * Multi-group (SCM data) normal JSON.
     */
    public static final String JSON_MULTI_GROUP = """
            {
              "9133": [{"d":"4"}, {"e":"5"}],
              "4527": [{"c":"3"}, {"b":"2"}, {"a":"1"}]
            }
            """;
    public static final String CANONICALIZED_MULTI_GROUP = """
            {"4527":[{"c":"3"},{"b":"2"},{"a":"1"}],"9133":[{"d":"4"},{"e":"5"}]}""";
}
