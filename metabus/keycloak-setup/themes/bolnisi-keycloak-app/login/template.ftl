<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayWide=false>
    ...
    <head>
        ...
        <title>Cardano Foundation | Originate</title>
    ...
    <#if realm.internationalizationEnabled  && locale.supported?size gt 1>
        <select class="vodiapicker" id="kc-locale-wrapper-1">
            <#list locale.supported as l>
                <option value=${l.url} data-value=${l.url} data-thumbnail="${url.resourcesPath}/img/${l.languageTag}.svg" data-path="${url.resourcesPath}">
                    ${l.label}
                </option>
            </#list>
        </select>
    ...
    <div class="${properties.kcLoginClass!}">
        ...
        <div class="${properties.kcFormCardClass!} <#if displayWide>${properties.kcFormCardAccountClass!}</#if>">
            <header class="${properties.kcFormHeaderClass!}">
                <h1 id="kc-page-title" class="text-custom"><#nested "header"></h1>
                <h1 id="kc-page-title-custom" class="text-custom"><#nested "header-custom"></h1>
            </header>
            <div id="kc-content">
