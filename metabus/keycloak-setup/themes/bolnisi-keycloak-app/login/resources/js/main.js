...
function loadingDefault() {
    ...
    let  element = document.getElementById("kc-page-title")
    let  elementCustom = document.getElementById("kc-page-title-custom")
    if(!element.innerText){
        element.style.display="none"
    }
    if(!elementCustom.innerText){
        elementCustom.style.display="none"
    }
    ...
    $(function () {
        ...
        $('.vodiapicker option').each(function () {
            ...
            if (langChang === extractKcLocale(value)) {
                itemCheck = '<li><div style="display: flex"><img style="width: 30px;height: 30px;" src="' + img + '" alt="" value="' + value + '"/>' +
                    '<img id="icon-expand" style="width: 24px;height: 30px;" src="' + iconDown + '"/></div></li>';
