...
public class ProducerConfiguration {
    ...
    private final TestKafkaProperties testKafkaProperties;

    public ProducerConfiguration(TestKafkaProperties testKafkaProperties) {
        this.testKafkaProperties = testKafkaProperties;
    }
    ...
    public ProducerFactory<String, Object> producerFactory() {
        var jsonConfigs = testKafkaProperties.getProducers().get(JSON_SERIALIZER);

        return new DefaultKafkaProducerFactory<>(jsonProducerConfigs(jsonConfigs));
    }

    @SneakyThrows
    private Map<String, Object> jsonProducerConfigs(TestKafkaProperties.ProducerConfig jsonConfigs) {
