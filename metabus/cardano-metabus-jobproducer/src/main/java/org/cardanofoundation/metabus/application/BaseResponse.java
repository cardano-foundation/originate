...
import org.cardanofoundation.metabus.application.exceptions.JobProducerError;
import lombok.Data;
...
public class BaseResponse<T> {
    ...
    public static BaseResponse<Void> ofFailed(JobProducerError errorCode, String message) {
